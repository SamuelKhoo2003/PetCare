...
import mockupImageSrc from "images/download-app.jpg"
...
const Subheading = tw(SubheadingBase)`text-gray-200 mb-4 tracking-wider`
...
export default ({
  ...
  text = "Owners all over the world are happily using PetCare.",
  link1Text = "App Store",
    ...
    <Container css={pushDownFooter && tw`mb-20 lg:mb-24`}>
      <Content>
        <Row>
          ...
          <ImageContainer>
            <img src={imageSrc} alt="" tw="w-64 rounded-md"/>
          </ImageContainer>
        </Row>
