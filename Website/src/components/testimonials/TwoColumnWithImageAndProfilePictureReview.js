...
const Description = tw.p`max-w-md text-center mx-auto lg:mx-0 lg:text-left lg:max-w-none leading-relaxed text-sm sm:text-base lg:text-lg font-medium mt-4 text-secondary-300`;
...
const CustomerTextInfo = tw.div`text-center lg:text-left sm:ml-6 mt-2 sm:mt-0 mb-2`;
const CustomerName = tw.h5`font-semibold text-xl lg:text-2xl xl:text-3xl text-primary-500 mb-0`;
...
export default ({
  ...
  description = "Here’s what some of our amazing customers are saying about our pet tracking devices. Our advanced monitoring systems provide real-time tracking, ensuring the safety and well-being of your pets wherever they go. ",
  testimonials = null,
  textOnLeft = true
}) => {
  /*
  ...
  const defaultTestimonials = [
    {
      ...
      quote:
        "I love how I can track my cat’s location with the pet tracker. It’s so comforting to know exactly where she is, whether she’s exploring the backyard or roaming around the neighborhood.",
      customerName: "Sophia Green",
      customerTitle: "Cat Owner"
    },
    {
      imageSrc:
        require("../../images/labrador.jpg"),
      profileImageSrc:
        "https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2.25&w=512&h=512&q=80",
      quote:
        "The pet tracker not only gives me the location of my dog, but it also monitors the temperature and weather around him. I can ensure he's in a safe, comfortable environment wherever he is.",
      customerName: "John Davis",
      customerTitle: "Labrador Retriever Owner"
    },
    {
      imageSrc:
        require("../../images/daschund.jpg"),
      profileImageSrc:
        require("../../images/christian-profile.jpg"),
      quote:
        "The mobile app is a game-changer! I can monitor my pet’s location, temperature, and caloric data on the fly, no matter where I am. It’s incredibly easy to use and provides me with real-time updates for total peace of mind.",
      customerName: "Oliver Mitchell",
      customerTitle: "Dachshund Owner"
    }
  ];
